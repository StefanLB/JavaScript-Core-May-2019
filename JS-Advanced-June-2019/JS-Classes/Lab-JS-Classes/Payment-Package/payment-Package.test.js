...
describe('PaymentPackage class tests', () => {
    ...
    describe('constructor method tests', () => {
        ...
        it('should be created with single correct params', () => {
            assert.deepEqual(paymentPackage,
                { _name: 'HR Services', _value: 1000, _VAT: 20, _active: true });
        });

        it('should be created with multiple correct params', () => {
            paymentPackage = [
            ...
            assert.deepEqual(paymentPackage,
                [{ _name: 'HR Services', _value: 1500, _VAT: 20, _active: true },
                { _name: 'Consultation', _value: 800, _VAT: 20, _active: true },
                { _name: 'Partnership Fee', _value: 7000, _VAT: 20, _active: true }]);
        });
    });
    ...
    describe('accessor name tests', () => {
        ...
        it('should throws an error for not a string', () => {
            const error = () => paymentPackage.name = { a: 1 };
